...
def get_oss_url(name, sha256, url):
    """ Get internal OSS URL of the library. """
    ...
    return "http://raylet.cn-hangzhou-alipay-b.oss-cdn.aliyun-inc.com/ci/" + file_name
...
def ray_deps_setup(local_thirdparty_path):
    ...
    auto_http_archive(
        ...
        patches = [
            ...
            "//thirdparty/patches:glog-merge-messages-in-signalhandler.patch",
        ],
    )
    ...
    auto_http_archive(
        ...
        patches = [
            ...
            "//thirdparty/patches:opencensus-cpp-support-kdelta-views-report.patch",
        ]
    )
...
#    )
    ...
    # http_archive(
    #     name = "com_github_brpc_brpc",
    #     strip_prefix = "incubator-brpc-1d6510aa50075cade5ed539ee09a11a1b8d7f990",
    #     url = "http://raylet.cn-hangzhou-alipay-b.oss-cdn.aliyun-inc.com/ci/brpc/brpc-0.9.7-rc05.tar.gz",
    #     sha256 = "018fd12a8b841b798e1f697f5d66825b7c5e9e26fe37297568a9276c0312c358",
    #     patches = [
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-BUILD.patch",
    #         #"@com_github_ray_project_ray//thirdparty/patches:brpc-fix.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-in-place-execution-and-pthread-num.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-fix-mac-requires-xcode.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-fix-symbol-not-found-on-mac.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-make-stream-message-handler-owned-by-brpc.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-no_register_pthread_atfork_in_child_process.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-build_rpc_view.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-find-ssl-path.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-fix-profiler.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-set-failed-for-stream-connections-to-fix-server-shutdown-hang.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-use-glog.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-fix-profiler-failure-when-SIGCHLD-is-ignored.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-fix-heap-profiler-dlsym-when-called-in-so.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-fix-sigaction-on-mac.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-allow-set-program-name.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-remove-resolve-hostname.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-mod-log-level.patch",
    #         "@com_github_ray_project_ray//thirdparty/patches:brpc-do-not-get-username-in-bvar.patch",
    #     ],
    # )
