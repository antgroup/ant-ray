...
class ActorCreator {
 public:
  ...
  ray::ActorHandleCpp<GetActorType<F>, is_x_lang_v<F>> Remote(Args &&... args);
...
template <typename F>
template <typename... Args>
ActorHandleCpp<GetActorType<F>, is_x_lang_v<F>> ActorCreator<F>::Remote(Args &&... args) {
  ...
  return ActorHandleCpp<GetActorType<F>, is_x_lang_v<F>>(returned_actor_id);
}
}  // namespace internal
}  // namespace ray
