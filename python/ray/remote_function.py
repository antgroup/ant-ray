...
DEFAULT_REMOTE_FUNCTION_CPUS = 0.01 if gcs_task_scheduling_enabled() else 1
...
class RemoteFunction:
    ...
    def __init__(self, language, function, function_descriptor, num_cpus,
                 ...
                 retry_exceptions, scheduling_strategy: SchedulingStrategyT):
    ...
    def _remote(self,
        ...
        if isinstance(scheduling_strategy, ActorAffinitySchedulingStrategy):
            raise ValueError("The actor affinity scheduling strategy "
                             "can't be used to normal tasks.")
