...
def create_parser(parser_creator=None):
    ...
    parser.add_argument(
        ...
        default=30,
        type=int,
        help="Syncing period for syncing worker logs to driver.")
    parser.add_argument(
        "--node-sync-period",
        default=30,
        type=int,
        help="Syncing period for syncing local checkpoints to cloud.")
    return parser
...
def run(args, parser):
    ...
    sync_config.cloud_sync_period = args.cloud_sync_period
    sync_config.node_sync_period = args.node_sync_period
