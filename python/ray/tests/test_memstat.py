...
def test_actor_task_refs(ray_start_regular):
    ...
    # ANT-INTERNAL: Due to https://code.alipay.com/Arc/X/pull_requests/9695,
    # An actor should hold a reference to itself, hence here we have both
    # ACTOR_HANDLE and PINNED_IN_MEMORY of the worker process.
    assert count(info, WORKER_PID) == 2, info
