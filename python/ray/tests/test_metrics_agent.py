...
@pytest.mark.skip(
    reason="skip this test cause the metrics exporter is disabled")
...
# TODO(buhe): skip this test cause the prometheus exporter is disabled
# should enable this test after fix exporter
@pytest.mark.skip("skip this test cause the prometheus exporter is disabled")
@pytest.mark.skipif(
