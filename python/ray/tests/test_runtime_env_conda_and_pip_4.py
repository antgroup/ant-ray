...
def test_in_virtualenv(start_cluster):
    assert (PipProcessor._is_in_virtualenv() is False and "IN_VIRTUALENV" not in os. environ) or \
           (PipProcessor._is_in_virtualenv() is True and "IN_VIRTUALENV" in os.environ)
