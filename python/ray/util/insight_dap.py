...
class DAPClient:
    ...
    async def send_request(self, command: str, args: Dict[str, Any] = None, 
    ...
    async def send_request_and_wait(self, command: str, args: Dict[str, Any] = None,
    ...
    async def disconnect_request(self) -> Dict[str, Any]:
        ...
        Returns:
            The response from the debug adapter
        """
        return await self.send_request_and_wait("disconnect", {
            "restart": False,
