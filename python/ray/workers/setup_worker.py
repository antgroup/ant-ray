...
def start_worker_in_container(container_option, args, remaining_args):
    ...
    container_command = [
        ...
        "--ipc=host", "--env-host", "--cgroups=no-conmon", "--ulimit=host"
    ]
    ...
    # pass RAY_JOB_DATA_DIR_BASE env
    container_command.append("--env")
    container_command.append("RAY_JOB_DATA_DIR_BASE=" +
                             os.getenv("RAY_JOB_DATA_DIR_BASE", ""))
