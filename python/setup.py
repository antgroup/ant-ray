...
class build_ext(_build_ext.build_ext):
    def run(self):
        ...
        # Copy over the generated ray files.
        ...
        # Copy over the already existed ray files.
        ...
        for filename in os.listdir(generated_python_directory):
            if filename[-3:] == ".py":
                ...
                destination = os.path.join(self.build_lib, source)
                self.move_file(source, destination)
        ...
        for filename in optional_ray_files_generated:
            try:
                ...
                print("Failed to copy optional file {}. This is ok."
                      .format(filename))
        # Copy over the already existed optional files.
