"""
This script is a copy of the ray/scripts/check_import_order.py.
This script ensures python files conform to ragent's import ordering rules.
In particular, we make sure psutil and setproctitle is imported _after_
importing a due to our bundling of the two libraries.
