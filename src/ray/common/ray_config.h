...
#undef RAY_CONFIG
 ...
 public:
  bool validate(const std::string &config_json_str, std::string *error_message = nullptr);
  bool update(const std::string &config_json_str, std::string *error_message = nullptr);
  std::string dump_to_json_str() const;
