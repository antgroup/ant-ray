...
ray::rpc::ActorHandle CreateInnerActorHandle(
    ...
    const std::string &ray_namespace, bool enable_task_fast_fail) {
...
ray::rpc::ActorHandle CreateInnerActorHandleFromActorTableData(
    const ray::rpc::ActorTableData &actor_table_data, const std::string &name,
...
ActorHandle::ActorHandle(
    ...
    : ActorHandle(CreateInnerActorHandle(
          ...
          ray_namespace, enable_task_fast_fail)) {}
...
ActorHandle::ActorHandle(const rpc::ActorTableData &actor_table_data,
    ...
    : ActorHandle(CreateInnerActorHandleFromActorTableData(actor_table_data, name,
                                                           ray_namespace)) {}

void ActorHandle::SetActorTaskSpec(TaskSpecBuilder &builder, const ObjectID new_cursor,
                                   std::optional<bool> enable_task_fast_fail) {
  ...
  builder.SetActorTaskSpec(GetActorID(), actor_creation_dummy_object_id,
                           ...
                           task_counter_++,
                           enable_task_fast_fail ? (enable_task_fast_fail == true)
                                                 : inner_.enable_task_fast_fail());
