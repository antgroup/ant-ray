...
/// GetValue of Boolean class
extern jmethodID java_boolean_value;
...
/// Integer class
extern jclass java_integer_class;
/// intValue method of Integer class
extern jmethodID java_integer_int_value;
...
extern jclass java_illegal_argument_exception_class;
...
/// ignoreReturn field of CallOptions class
extern jfieldID java_call_options_ignore_return;
/// scheduling strategy field of CallOptions class
extern jfieldID java_call_options_scheduling_strategy;

/// ActorCallOptions class
extern jclass java_actor_call_options_class;
/// ignoreReturn field of ActorCallOptions class
extern jfieldID java_actor_call_options_ignore_return;
/// enableTaskFastFail field of ActorCallOptions class
extern jfieldID java_actor_call_options_enable_task_fast_fail;
...
/// serializedRuntimeEnv field of ActorCreationOptions class
...
/// is_async field of ActorCreationOptions class
extern jfieldID java_actor_creation_options_is_async;
/// customer extended properties
extern jfieldID java_actor_creation_options_extended_properties;
/// concurrentGroups field of ActorCreationOptions class
extern jfieldID java_actor_creation_options_concurrent_groups;
...
/// labels field of ActorCreationOptions class
extern jfieldID java_actor_creation_options_labels;
/// schedulingStrategy field of ActorCreationOptions class
extern jfieldID java_actor_creation_options_scheduling_strategy;

/// ActorAffinityOperator class
extern jclass java_actor_affinity_operator_class;
/// value field of ActorAffinityOperator class
extern jfieldID java_actor_affinity_operator_value;

/// ActorAffinityMatchExpression class
extern jclass java_actor_affinity_match_expression_class;
/// key field of ActorAffinityMatchExpression class
extern jfieldID java_actor_affinity_match_expression_key;
/// operator field of ActorAffinityMatchExpression class
extern jfieldID java_actor_affinity_match_expression_operator;
/// values field of ActorAffinityMatchExpression class
extern jfieldID java_actor_affinity_match_expression_values;
/// soft field of ActorAffinityMatchExpression class
extern jfieldID java_actor_affinity_match_expression_soft;

/// SchedulingStrategy class
extern jclass java_scheduling_strategy_class;
/// ActorAffinitySchedulingStrategy class
extern jclass java_actor_affinity_scheduling_strategy_class;
/// actorAffinityMatchExpression field of ActorAffinitySchedulingStrategy class
extern jfieldID java_actor_affinity_scheduling_strategy_actor_affinity_match_expressions;

/// NodeAffinitySchedulingStrategy class
extern jclass java_node_affinity_scheduling_strategy_class;
/// nodes field of NodeAffinitySchedulingStrategy class
extern jfieldID java_node_affinity_scheduling_strategy_nodes;
/// soft field of NodeAffinitySchedulingStrategy class
extern jfieldID java_node_affinity_scheduling_strategy_soft;
/// anti_affinity field of NodeAffinitySchedulingStrategy class
extern jfieldID java_node_affinity_scheduling_strategy_anti_affinity;
...
extern jclass java_ray_native_runtime_class;
extern jmethodID java_ray_native_runtime_class_on_actor_state_changed;
extern jmethodID java_ray_native_runtime_class_on_actor_migration_event;
...
#define THROW_EXCEPTION_AND_RETURN_IF_NOT_OK(env, status, ret)                         \
  {                                                                                    \
    if (!(status).ok()) {                                                              \
      if (status.IsInvalid()) {                                                        \
        (env)->ThrowNew(java_illegal_argument_exception_class,                         \
...
class JavaByteArrayBuffer : public ray::Buffer {
 public:
  ...
  size_t Size() const override {
    return env_->GetArrayLength(java_byte_array_);
    RAY_CHECK_JAVA_EXCEPTION(env_);
  }
...
template <>
inline jobject NativeVectorToJavaList(
    JNIEnv *env, const std::vector<bool> &native_vector,
    std::function<jobject(JNIEnv *, const bool &)> element_converter) {
  jobject java_list =
      env->NewObject(java_array_list_class, java_array_list_init_with_capacity,
                     (jint)native_vector.size());
...
inline std::shared_ptr<ray::LocalMemoryBuffer> SerializeActorCreationException(
  ...
  jbyteArray exception_jbyte_array = static_cast<jbyteArray>(env->CallStaticObjectMethod(
      java_ray_exception_serializer_class, java_ray_exception_serializer_to_bytes,
      creation_exception));
