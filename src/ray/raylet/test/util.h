...
class MockWorker : public WorkerInterface {
 public:
  ...
  void MarkDead(bool actor_needs_restart = false) { RAY_CHECK(false) << "Method unused"; }
  ...
  void SetAssignmentId(const UniqueID &assignemnt_id) {
    RAY_CHECK(false) << "Method unused";
  }

  const UniqueID &GetAssignmentId() const {
    RAY_CHECK(false) << "Method unused";
    static UniqueID nil = UniqueID::Nil();
    return nil;
  }
  ...
  void ResetActorId() { RAY_CHECK(false) << "Method unused"; }
  ...
  /////////////////////////////ANT-INTERNAL/////////////////////////////
  bool IsForActor() const { return is_for_actor_; }

  void SetIsForActor(bool is_for_actor) { is_for_actor_ = is_for_actor; }
  ...
  double GetResourceViolation() { return resource_violation_; }
