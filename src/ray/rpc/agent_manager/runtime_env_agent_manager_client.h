...
class RuntimeEnvAgentManagerClient {
 public:
  /// Constructor.
  ///
  ...
  VOID_RPC_CLIENT_METHOD(RuntimeEnvAgentManagerService,
                         RegisterRuntimeEnvAgent,
                         grpc_client_,
                         /*method_timeout_ms*/ -1, )

 private:
  /// The RPC client.
  std::unique_ptr<GrpcClient<RuntimeEnvAgentManagerService>> grpc_client_;
};
