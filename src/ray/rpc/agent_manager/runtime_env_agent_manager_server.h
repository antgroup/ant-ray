...
#include "src/ray/protobuf/runtime_env_agent_manager.grpc.pb.h"
#include "src/ray/protobuf/runtime_env_agent_manager.pb.h"
...
class RuntimeEnvAgentManagerGrpcService : public GrpcService {
 ...
 protected:
  ...
  void InitServerCallFactories(
    ...
    RAY_RUNTIME_ENV_AGENT_MANAGER_RPC_HANDLERS
  }

 private:
  /// The grpc async service object.
  RuntimeEnvAgentManagerService::AsyncService service_;
  /// The service handler that actually handle the requests.
  RuntimeEnvAgentManagerServiceHandler &service_handler_;
};
