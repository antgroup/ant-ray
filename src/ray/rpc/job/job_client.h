...
#ifndef RAY_JOB_CLIENT_H
#define RAY_JOB_CLIENT_H
...
class JobClientInterface {
 public:
  virtual void InitializeJobEnv(const InitializeJobEnvRequest &request,
                                const ClientCallback<InitializeJobEnvReply> &callback) {}
  virtual void CleanJobEnv(const CleanJobEnvRequest &request,
                           const ClientCallback<CleanJobEnvReply> &callback) {}
  virtual ~JobClientInterface(){};
};
...
class JobClient : public JobClientInterface {
 public:
  ...
  /// \param request The request message
  /// \param callback  The callback function that handles reply
  VOID_RPC_CLIENT_METHOD(JobAgentService, CleanJobEnv, grpc_client_, )
