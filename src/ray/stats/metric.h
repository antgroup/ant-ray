...
class StatsConfig final {
 public:
  ...
  void SetCeresdbExporterEnabled(bool ceresdb_exporter_enabled);

  bool GetCeresdbExporterEnabled() const;

  void SetCeresdbConfFile(const std::string &ceresdb_conf_file);
