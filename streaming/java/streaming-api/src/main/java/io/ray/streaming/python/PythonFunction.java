...
public class PythonFunction implements Function {
  public static final String FUNCTION_MODULE = "raystreaming.function";
  ...
  public String toSimpleString() {
    if (function != null) {
      return functionInterface + "_binary";
    } else {
      return String.format("%s_%s.%s", functionInterface, moduleName, functionName);
    }
  }
  ...
  public String toString() {
    ...
    if (function != null) {
      stringJoiner.add("function=binary");
    } else {
      stringJoiner
