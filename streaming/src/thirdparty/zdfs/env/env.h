...
#ifndef ZDFS_INCLUDE_ENV_H_
#define ZDFS_INCLUDE_ENV_H_
...
struct EnvOptions {
  ...
  // if true, use O_TRUNC to write/open a file
...
class Env {
 public:
  ...
  // Seal a file in case split brain on DFS
...
// Returns a new environment that is used for Pangu environment.
// This is a factory method for PanguEnv declared in env_pangu.h
Status NewPanguEnv(unique_ptr<Env>* pangu_env, const std::string& fsname);

}  // namespace zdfs

#endif  // ZDFS_INCLUDE_ENV_H_
