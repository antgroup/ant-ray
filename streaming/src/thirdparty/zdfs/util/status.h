...
#ifndef ZDFS_INCLUDE_STATUS_H_
#define ZDFS_INCLUDE_STATUS_H_
...
class Status {
 public:
  ...
  static Status AccessDenied(SubCode msg = kNone) { return Status(kAccessDeny, msg); }
  static Status AccessDenied(const Slice& msg, const Slice& msg2 = Slice()) {
    return Status(kAccessDeny, msg, msg2);
  }

  static Status QuotaExceed(SubCode msg = kNone) { return Status(kQuotaExceeded, msg); }
  static Status QuotaExceed(const Slice& msg, const Slice& msg2 = Slice()) {
    return Status(kQuotaExceeded, msg, msg2);
  }
